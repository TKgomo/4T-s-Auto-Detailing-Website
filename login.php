...
if (isset($_POST['login'])) {
    ...
    if (!$result) {
        ...
        if (password_verify($password, $result['password'])) {
            ...
            echo '<p class="error">Username password combination is wrong! Please retry.  </p>';
        }
    }
}
?>
...
<body>
    ...
    <div class="container">
        ...
        <form method="post" action="" name="signin-form">
            ...
            <p>Admin? <a href="login-admin.php">Login Here</a></p>
            <p>Return to Home Page: <a href="Project.php">Click Here</a></p>
        </form>
        <a>Forgot Password? Please Email: tshego.tk123@gmail.com</a>
    </div>
</body>
</html>
